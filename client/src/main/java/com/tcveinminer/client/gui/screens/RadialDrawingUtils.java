...
public class RadialDrawingUtils {
    ...
    public static void fillArc(BufferBuilder buf, Matrix4f mat, float innerR, float outerR, float startRad,
            float endRad, int color) {
    ...
    public static void strokeArc(BufferBuilder buf, Matrix4f mat, float innerR, float outerR, float startRad,
            float endRad, float w, int color) {
    ...
    public static void strokeRing(BufferBuilder buf, Matrix4f mat, float r1, float r2, float startRad, float endRad,
            int color) {
    ...
    public static void strokeLine(BufferBuilder buf, Matrix4f mat, float r1, float r2, float angle, float w,
            int color) {
        float a = (color >> 24 & 0xFF) / 255f, r = (color >> 16 & 0xFF) / 255f,
                g = (color >> 8 & 0xFF) / 255f, b = (color & 0xFF) / 255f;

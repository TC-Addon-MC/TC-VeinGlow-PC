...
public final class TCVeinMinerEvents {
     ...
     */
    public static final Event<SessionStartCallback> SESSION_START = EventFactory.createArrayBacked(SessionStartCallback.class,
        (listeners) -> (event) -> {
     ...
     */
    public static final Event<SessionEndCallback> SESSION_END = EventFactory.createArrayBacked(SessionEndCallback.class,
        (listeners) -> (event) -> {
     ...
     */
    public static final Event<BlockBreakCallback> BLOCK_BREAK_PRE = EventFactory.createArrayBacked(BlockBreakCallback.class,
        (listeners) -> (event) -> {
     ...
     */
    public static final Event<BlockBreakPostCallback> BLOCK_BREAK_POST = EventFactory.createArrayBacked(BlockBreakPostCallback.class,
        (listeners) -> (event) -> {

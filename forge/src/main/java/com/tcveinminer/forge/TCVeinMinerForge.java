...
public final class TCVeinMinerForge {
        ...
        public TCVeinMinerForge() {
                ...
                // 5. Addons
                modBus.addListener(
                                (FMLCommonSetupEvent event) -> event
                                                .enqueueWork(() -> AddonLoader.loadAll(new AddonContextImpl())));

                // 6. Config screen (Forge 52+ via IExtensionPoint on ModLoadingContext)
                                                ...
                                                (minecraft, parent) -> {
                                                        me.shedaniel.clothconfig2.api.ConfigBuilder builder = me.shedaniel.clothconfig2.api.ConfigBuilder
                                                                        ...
                                                                        .setTitle(
                                                                                        net.minecraft.network.chat.Component
                                                                                                        .translatable("title.tcveinminer.config"));
                                                        builder.setSavingRunnable(
                                                                        () -> {
                                                                                com.tcveinminer.client.config.ClientConfigManager
                                                                                                .save();
                                                                                com.tcveinminer.config.ConfigManager
                                                                                                .save();
                                                                        });
                                                        me.shedaniel.clothconfig2.api.ConfigCategory general = builder
                                                                        .getOrCreateCategory(
                                                                                        net.minecraft.network.chat.Component
                                                                                                        .translatable("category.tcveinminer.general"));
                                                        me.shedaniel.clothconfig2.api.ConfigEntryBuilder entryBuilder = builder
                                                                        .entryBuilder();
                                                        general.addEntry(entryBuilder
                                                                        ...
                                                                        .setDefaultValue(
                                                                                        true)
                                                                        .setSaveConsumer(
                                                                                        newValue -> com.tcveinminer.config.ConfigManager
                                                                                                        .get().enabled = newValue)
                                                                        .build());

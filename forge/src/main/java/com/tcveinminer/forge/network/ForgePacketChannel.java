...
public final class ForgePacketChannel implements PacketChannel {
    ...
    public static final SimpleChannel CHANNEL = ChannelBuilder
            .named(ResourceLocation.fromNamespaceAndPath("tc_veinminer", "main"))
    ...
    public record ForgeConfigSyncPayload(int maxBlocks, List<String> blacklistedBlocks) implements CustomPacketPayload {
        public static final CustomPacketPayload.Type<ForgeConfigSyncPayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "config_sync"));
    ...
    public record ForgeMiningStatePayload(int state, int broken, int target) implements CustomPacketPayload {
        public static final CustomPacketPayload.Type<ForgeMiningStatePayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "mining_state"));
    ...
    public record ForgeActivationConfirmPayload(boolean allowContinuous) implements CustomPacketPayload {
        public static final CustomPacketPayload.Type<ForgeActivationConfirmPayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "activation_confirm"));
        public static final StreamCodec<RegistryFriendlyByteBuf, ForgeActivationConfirmPayload> CODEC = StreamCodec
                .composite(
    ...
    public record ForgeLookedAtBlockPayload(Optional<Long> pos) implements CustomPacketPayload {
        public static final CustomPacketPayload.Type<ForgeLookedAtBlockPayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "looked_at_block"));
        public static final StreamCodec<RegistryFriendlyByteBuf, ForgeLookedAtBlockPayload> CODEC = StreamCodec
                .composite(
    ...
    public record ForgeFilterResultPayload(boolean allowHighlight) implements CustomPacketPayload {
        public static final CustomPacketPayload.Type<ForgeFilterResultPayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "filter_result"));
        public static final StreamCodec<RegistryFriendlyByteBuf, ForgeFilterResultPayload> CODEC = StreamCodec
                .composite(
    ...
    public record ForgeHighlightBlockListPayload(List<Long> blocks,
        ...
        public static final CustomPacketPayload.Type<ForgeHighlightBlockListPayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "highlight_block_list"));
        public static final StreamCodec<RegistryFriendlyByteBuf, ForgeHighlightBlockListPayload> CODEC = StreamCodec
                .composite(
    ...
    public record ForgeHighlightDeltaPayload(List<Long> addedBlocks,
            ...
            String highlightStyle, String source) implements CustomPacketPayload {
        public static final CustomPacketPayload.Type<ForgeHighlightDeltaPayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "highlight_delta"));
        public static final StreamCodec<RegistryFriendlyByteBuf, ForgeHighlightDeltaPayload> CODEC = StreamCodec
                .composite(
    ...
    public record ForgeHoldKeyPayload(boolean isHolding, String shapeId, int maxBlocks,
        ...
        public static final CustomPacketPayload.Type<ForgeHoldKeyPayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "hold_key"));
    ...
    public record ForgeActivationRequestPayload(boolean active,
        ...
        public static final CustomPacketPayload.Type<ForgeActivationRequestPayload> TYPE = new CustomPacketPayload.Type<>(
                ResourceLocation.fromNamespaceAndPath("tc_veinminer", "activation_request"));
        public static final StreamCodec<RegistryFriendlyByteBuf, ForgeActivationRequestPayload> CODEC = StreamCodec
                .composite(
    ...
    public void registerPackets() {
        ...
        CHANNEL.messageBuilder(ForgeHoldKeyPayload.class, NetworkProtocol.PLAY)
                ...
                .consumerMainThread((payload, context) -> {
                    com.tcveinminer.network.handlers.HoldKeyHandler.handleRaw(
                            context.getSender(),
                            new HoldKeyData(payload.isHolding(), payload.shapeId(), payload.maxBlocks(),
        ...
        // S2C
        registerS2C(ForgeConfigSyncPayload.class, ForgeConfigSyncPayload.CODEC,
                com.tcveinminer.forge.client.network.ForgeClientPayloadHandler::handleConfigSync);
        registerS2C(ForgeMiningStatePayload.class, ForgeMiningStatePayload.CODEC,
                com.tcveinminer.forge.client.network.ForgeClientPayloadHandler::handleMiningState);
        registerS2C(ForgeActivationConfirmPayload.class, ForgeActivationConfirmPayload.CODEC,
                com.tcveinminer.forge.client.network.ForgeClientPayloadHandler::handleActivationConfirm);
        registerS2C(ForgeLookedAtBlockPayload.class, ForgeLookedAtBlockPayload.CODEC,
                com.tcveinminer.forge.client.network.ForgeClientPayloadHandler::handleLookedAtBlock);
        registerS2C(ForgeFilterResultPayload.class, ForgeFilterResultPayload.CODEC,
                com.tcveinminer.forge.client.network.ForgeClientPayloadHandler::handleFilterResult);
        registerS2C(ForgeHighlightBlockListPayload.class, ForgeHighlightBlockListPayload.CODEC,
                com.tcveinminer.forge.client.network.ForgeClientPayloadHandler::handleHighlightBlockList);
        registerS2C(ForgeHighlightDeltaPayload.class, ForgeHighlightDeltaPayload.CODEC,
                com.tcveinminer.forge.client.network.ForgeClientPayloadHandler::handleHighlightDelta);
    }

    private <T extends CustomPacketPayload> void registerS2C(Class<T> clazz,
            StreamCodec<RegistryFriendlyByteBuf, T> codec, java.util.function.Consumer<T> clientHandler) {
    ...
    public void sendToPlayer(Object player, NetworkPacket packet) {
        CHANNEL.send(toForgePayload(packet),
    ...
    public void sendToAll(NetworkPacket packet, Iterable<?> players) {
        ...
        for (var player : players) {
            CHANNEL.send(p, net.minecraftforge.network.PacketDistributor.PLAYER.with(
                    (net.minecraft.server.level.ServerPlayer) player));
        }
    }
    ...
    public static CustomPacketPayload toForgePayload(NetworkPacket packet) {
        return switch (packet) {
            ...
            case HighlightBlockListData d ->
                new ForgeHighlightBlockListPayload(d.blocks(), d.highlightStyle(), d.source());
            case HighlightDeltaData d ->
                new ForgeHighlightDeltaPayload(d.addedBlocks(), d.removedBlocks(), d.highlightStyle(), d.source());
            case HoldKeyData d ->
                new ForgeHoldKeyPayload(d.isHolding(), d.shapeId(), d.maxBlocks(), d.equation(), d.blacklist());
